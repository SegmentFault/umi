        ...
        exit(path, { opts }) {
          ...
          while (index >= 0) {
            ...
            if (t().isImportDeclaration(d)) {
              ...
              (_opts$onTransformDeps = opts.onTransformDeps) === null ||
              _opts$onTransformDeps === void 0
                ? void 0
                : _opts$onTransformDeps.call(opts, {
              ...
              if (isMatch) {
                const _specifiersToProperti = specifiersToProperties(
                    d.specifiers,
                  ),
                  properties = _specifiersToProperti.properties,
                  namespaceIdentifier =
                    _specifiersToProperti.namespaceIdentifier;
            ...
            if (t().isExportAllDeclaration(d) && d.source) {
              ...
              (_opts$onTransformDeps2 = opts.onTransformDeps) === null ||
              _opts$onTransformDeps2 === void 0
                ? void 0
                : _opts$onTransformDeps2.call(opts, {
                    source: d.source.value,
                    file: path.hub.file.opts.filename,
                    isMatch: false,
            ...
            if (t().isExportNamedDeclaration(d) && d.source) {
              ...
              (_opts$onTransformDeps3 = opts.onTransformDeps) === null ||
              _opts$onTransformDeps3 === void 0
                ? void 0
                : _opts$onTransformDeps3.call(opts, {
                    source: d.source.value,
                    file: path.hub.file.opts.filename,
                    isMatch,
                  });
              ...
              if (isMatch) {
                const _specifiersToProperti2 = specifiersToProperties(
                    d.specifiers,
                  ),
