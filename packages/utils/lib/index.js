...
var _compatESModuleRequire = _interopRequireDefault(
  require('./compatESModuleRequire/compatESModuleRequire'),
);

var _mergeConfig = _interopRequireDefault(require('./mergeConfig/mergeConfig'));

var _isLernaPackage = _interopRequireDefault(
  require('./isLernaPackage/isLernaPackage'),
);
...
var _parseRequireDeps = _interopRequireDefault(
  require('./parseRequireDeps/parseRequireDeps'),
);

var _BabelRegister = _interopRequireDefault(
  require('./BabelRegister/BabelRegister'),
);
...
var _cleanRequireCache = _interopRequireDefault(
  require('./cleanRequireCache/cleanRequireCache'),
);
