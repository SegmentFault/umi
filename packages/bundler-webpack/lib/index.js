...
class Bundler {
  constructor({ cwd, config }) {
    ...
    this.getIgnoredWatchRegExp = () => {
      ...
      const absOutputPath = _utils().lodash.escapeRegExp(
        (0, _utils().winPath)((0, _path().join)(this.cwd, outputPath, '/')),
  ...
  getConfig(opts) {
    ...
    return _asyncToGenerator(function* () {
      return yield (0, _getConfig.default)(
        _objectSpread(
          _objectSpread({}, opts),
          {},
          {
  ...
  build({ bundleConfigs, bundleImplementor = _webpack().default }) {
    return _asyncToGenerator(function* () {
  ...
  setupDevServerOpts({
    ...
    const compilerMiddleware = (0, _webpackDevMiddleware().default)(
      compiler,
      _objectSpread(
        _objectSpread(
          {
        ...
        {},
        {
          writeToDisk:
            devServer &&
            (devServer === null || devServer === void 0
              ? void 0
