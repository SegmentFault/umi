          ...
          case exports.ApplyPluginsType.modify:
            if (async) {
                          ...
                          switch ((_context.prev = _context.next)) {
                            ...
                            case 20:
                              return _context.abrupt(
                                'return',
                                _objectSpread2(_objectSpread2({}, memo), hook),
                              );
              ...
              return hooks.reduce(function (memo, hook) {
                assert(
                  typeof hook === 'function' || _typeof(hook) === 'object',
                  'applyPlugins failed, all hooks for key '.concat(
                    key,
...
function render(loaded, props) {
  return /*#__PURE__*/ React.createElement(resolve(loaded), props);
}
...
function createLoadableComponent(loadFn, options) {
  ...
  var LoadableComponent = function LoadableComponent(props, ref) {
    init();
    var context = React.useContext(LoadableContext);
  ...
  var LoadableComponentWithRef = /*#__PURE__*/ React.forwardRef(
    LoadableComponent,
