...
class Server {
  constructor(opts) {
    ...
    this.opts = _objectSpread(
      _objectSpread({}, defaultOpts),
      _utils().lodash.omitBy(opts, _utils().lodash.isUndefined),
    );
  ...
  setupCompress() {
    const compressOpts = _utils().lodash.isBoolean(this.opts.compress)
      ? {}
      : this.opts.compress;
  ...
  setupProxy(proxyOpts, isWatch = false) {
    ...
    if (!Array.isArray(proxy)) {
      if (proxy && 'target' in proxy) {
        ...
        proxy = Object.keys(proxy || {}).map((context) => {
          ...
          if (
            typeof ((_proxy = proxy) === null || _proxy === void 0
              ? void 0
              : _proxy[context]) === 'string'
          ) {
            proxyOptions = {
            ...
            proxyOptions = _objectSpread(
              _objectSpread(
                {},
                ((_proxy2 = proxy) === null || _proxy2 === void 0
                  ? void 0
                  : _proxy2[context]) || {},
              ),
              {},
    ...
    const getProxyMiddleware = (proxyConfig) => {
      ...
      if (proxyConfig.target) {
        return (0, _httpProxyMiddleware().createProxyMiddleware)(
          context,
          _objectSpread(
            _objectSpread({}, proxyConfig),
            {},
            {
              onProxyRes(proxyRes, req, res) {
                ...
                const target =
                  typeof proxyConfig.target === 'object'
                    ...
                    : proxyConfig.target;
                const realUrl =
                  ((_URL = new URL(req.url || '', target)) === null ||
                  _URL === void 0
                    ? void 0
                    : _URL.href) || '';
                proxyRes.headers['x-real-url'] = realUrl;
                (_proxyConfig$onProxyR = proxyConfig.onProxyRes) === null ||
                _proxyConfig$onProxyR === void 0
                  ? void 0
                  : _proxyConfig$onProxyR.call(proxyConfig, proxyRes, req, res);
              },
            },
          ),
        );
    ...
    proxy.forEach((proxyConfigOrCallback) => {
      ...
      this.app.use((req, res, next) => {
        ...
        const bypassUrl = _utils().lodash.isFunction(proxyConfig.bypass)
