...
export declare function isPluginOrPreset(
  type: PluginType,
  name: string,
): boolean;
export declare function pathToObj({
  type,
  path,
  cwd,
}: {
...
export declare function resolvePresets(
  opts: IResolvePresetsOpts,
): {
  id: any;
  key: string;
  path: string;
