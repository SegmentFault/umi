...
export default class Service extends EventEmitter {
  ...
  applyAPI(opts: { apply: Function; api: PluginAPI }): Promise<any>;
  ...
  run({ name, args }: { name: string; args?: any }): Promise<void>;
  runCommand({ name, args }: { name: string; args?: any }): Promise<void>;
}
export {};
