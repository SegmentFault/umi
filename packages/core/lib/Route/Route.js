...
var _getConventionalRoutes = _interopRequireDefault(
  require('./getConventionalRoutes'),
);
  ...
  getRoutes(opts) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (!routes) {
        (0, _assert().default)(
          root,
          `opts.root must be supplied for conventional routes.`,
        );
  ...
  patchRoute(route, opts) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (
        ...
        route.path = (0, _utils().winPath)(
          (0, _path().join)(
            ((_opts$parentRoute = opts.parentRoute) === null ||
            _opts$parentRoute === void 0
              ? void 0
              : _opts$parentRoute.path) || '/',
            route.path,
          ),
        );
      }
      ...
      if (route.redirect && route.redirect.charAt(0) !== '/') {
        ...
        route.redirect = (0, _utils().winPath)(
          (0, _path().join)(
            ((_opts$parentRoute2 = opts.parentRoute) === null ||
            _opts$parentRoute2 === void 0
              ? void 0
              : _opts$parentRoute2.path) || '/',
            route.redirect,
          ),
        );
      }
      ...
      if (
        ...
        !_path().default.isAbsolute(route.component)
      ) {
        route.component = (0, _utils().winPath)(
          (0, _path().join)(opts.root, route.component),
        );
