...
function _default() {
  return {
    plugins: [
      ...
      require.resolve('./plugins/generateFiles/umi'), // bundle configs
      ...
      require.resolve('./plugins/features/runtimeHistory'), // html
      ...
      require.resolve('./plugins/features/html/title'), // commands
