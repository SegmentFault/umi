...
var _default = (api) => {
  ...
  api.modifyConfig((memo) => {
    ...
    if (
      (_memo$exportStatic = memo.exportStatic) === null ||
      _memo$exportStatic === void 0
        ? void 0
        : _memo$exportStatic.dynamicRoot
    ) {
  ...
  api.onPatchRoute(({ route }) => {
    ...
    if (
      !((_api$config$exportSta = api.config.exportStatic) === null ||
      _api$config$exportSta === void 0
        ? void 0
        : _api$config$exportSta.htmlSuffix)
    )
      return;
  ...
  api.modifyProdHTMLContent(
    /*#__PURE__*/ (function () {
      var _ref2 = _asyncToGenerator(function* (memo, args) {
        const route = args.route;
        const serverFilePath = (0, _path().join)(
        ...
        if (
          ssr &&
          api.env === 'production' &&
          (0, _fs().existsSync)(serverFilePath) &&
          !(0, _utils2.isDynamicRoute)(route.path)
        ) {
          try {
