...
var _createPageGenerator = _interopRequireDefault(
  require('./PageGenerator/createPageGenerator'),
);

var _createTmpGenerator = _interopRequireDefault(
  require('./TmpGenerator/createTmpGenerator'),
);

var _createHTMLGenerator = _interopRequireDefault(
  require('./HTMLGenerator/createHTMLGenerator'),
);
