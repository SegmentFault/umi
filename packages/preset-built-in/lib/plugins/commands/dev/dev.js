...
var _default = (api) => {
  ...
  function destroy() {
    ...
    (_server = server) === null || _server === void 0
      ? void 0
      : (_server$listeningApp = _server.listeningApp) === null ||
        _server$listeningApp === void 0
      ? void 0
      : _server$listeningApp.close();
  }
  ...
  api.registerCommand({
    ...
    fn: (function () {
      var _fn = _asyncToGenerator(function* ({ args }) {
        var _api$config$devServer,
          _api$config$devServer2,
          _process$send,
          _process;

        const defaultPort = // @ts-ignore
          process.env.PORT ||
          (args === null || args === void 0 ? void 0 : args.port) ||
          ((_api$config$devServer = api.config.devServer) === null ||
          _api$config$devServer === void 0
            ? void 0
            : _api$config$devServer.port);
        ...
        hostname =
          process.env.HOST ||
          ((_api$config$devServer2 = api.config.devServer) === null ||
          _api$config$devServer2 === void 0
            ? void 0
            : _api$config$devServer2.host) ||
          '0.0.0.0';
        ...
        const isHTTPS =
          process.env.HTTPS ||
          (args === null || args === void 0 ? void 0 : args.https);
              ...
              var _onChange = _asyncToGenerator(function* ({
                ...
                if (valueChanged.length) {
                  ...
                  if (reload) {
                    console.log();
                    api.logger.info(
                      `Config ${reloadConfigs.join(', ')} changed.`,
                    );
                    api.restartServer();
                  } else {
        ...
        const _yield$getBundleAndCo = yield (0,
          _buildDevUtils.getBundleAndConfigs)({
            api,
            port,
          }),
        ...
        server = new (_server2().Server)(
          _objectSpread(
            ...
            {},
            {
              ...
              afterMiddlewares: [
                ...middlewares,
                (0, _createRouteMiddleware.default)({
                  api,
                  sharedMap,
                }),
              ],
