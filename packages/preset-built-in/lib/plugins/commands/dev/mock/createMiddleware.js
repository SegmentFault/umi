...
const debug = (0, _utils().createDebug)(
  'umi:preset-build-in:mock:createMiddleware',
);
...
function _default(opts = {}) {
  ...
  watcher
    ...
    .on(
      'all', // debounce avoiding too much file change events
      _utils().lodash.debounce(
        /*#__PURE__*/ (function () {
          var _ref = _asyncToGenerator(function* (event, file) {
            ...
            data =
              (_yield$updateMockData = yield updateMockData()) === null ||
              _yield$updateMockData === void 0
                ? void 0
                : _yield$updateMockData.mockData;
