...
function _default(api) {
  ...
  const ignore = [
    ...
    ...((userConfig === null || userConfig === void 0
      ? void 0
      : (_userConfig$mock = userConfig.mock) === null ||
        _userConfig$mock === void 0
      ? void 0
      : _userConfig$mock.exclude) || []),
  ];
    ...
    /*#__PURE__*/ _asyncToGenerator(function* () {
      const checkConflictPaths = /*#__PURE__*/ (function () {
        var _ref2 = _asyncToGenerator(function* (mockRes) {
          ...
          if (
            (conflictPaths === null || conflictPaths === void 0
              ? void 0
      ...
      const _createMiddleware = (0, _createMiddleware2.default)(
          _objectSpread(
            _objectSpread({}, mockResult),
            {},
            {
