  ...
  apply(compiler) {
    ...
    compiler.hooks.done.tap('DevFirstCompileDone', (stats) => {
      ...
      if (stats.hasErrors()) {
        ...
        (_this$opts$onCompileF = (_this$opts = this.opts).onCompileFail) ===
          null || _this$opts$onCompileF === void 0
          ? void 0
          : _this$opts$onCompileF.call(_this$opts, {
              stats,
            });
        return;
      }
      ...
      if (isFirstCompile) {
        ...
        console.log(
          [
            `  App running at:`,
            `  - Local:   ${_utils().chalk.cyan(localUrl)} ${copied}`,
            lanUrl && `  - Network: ${_utils().chalk.cyan(lanUrl)}`,
          ]
            .filter(Boolean)
            .join('\n'),
        );
      ...
      (_this$opts$onCompileD = (_this$opts2 = this.opts).onCompileDone) ===
        null || _this$opts$onCompileD === void 0
        ? void 0
        : _this$opts$onCompileD.call(_this$opts2, {
            isFirstCompile,
            stats,
          });
