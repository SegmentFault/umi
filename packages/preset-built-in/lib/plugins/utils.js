 ...
 */
const getGlobalFile = ({ absSrcPath, files }) => {
  return files
    .map((file) => (0, _path().join)(absSrcPath || '', file))
...
const isDynamicRoute = (path) => {
  ...
  return !!(path === null || path === void 0
    ? void 0
    : (_path$split = path.split('/')) === null || _path$split === void 0
    ? void 0
    : (_path$split$some = _path$split.some) === null ||
      _path$split$some === void 0
    ? void 0
    : _path$split$some.call(_path$split, (snippet) => snippet.startsWith(':')));
};
/**
