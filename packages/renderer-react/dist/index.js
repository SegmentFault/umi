  ...
  return /*#__PURE__*/ React__default['default'].createElement(
    ...
    function (context) {
      ...
      return /*#__PURE__*/ React__default['default'].createElement(
        ...
        newProps.match
          ? render(
              _objectSpread2(_objectSpread2({}, props.layoutProps), newProps),
            )
          : null,
      );
    },
                ...
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 6:
                      ...
                      if (
                        !((_preloadComponent = preloadComponent) === null ||
                        _preloadComponent === void 0
                          ? void 0
...
function _render(_ref2) {
  ...
  if (Component) {
    ...
    var ret = /*#__PURE__*/ React__default['default'].createElement(
      Component,
      newProps,
      routes,
    ); // route.wrappers
  ...
  if (route.redirect) {
    ...
    if (
      ...
      _route$component === void 0
        ? void 0
        : _route$component.wrapInitialPropsLoaded) &&
  ...
  React.useEffect(
    function () {
      ...
      function routeChangeHandler(location, action) {
        var matchedRoutes = reactRouterConfig.matchRoutes(
          props.routes,
          location.pathname,
        ); // Set title
...
function _preloadComponent() {
  _preloadComponent = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee(readyRoutes) {
      var pathname,
        matchedRoutes,
        _iterator,
        _step,
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                matchedRoutes = reactRouterConfig.matchRoutes(
                  readyRoutes,
                  pathname,
                );
...
function renderClient(opts) {
  var rootContainer = opts.plugin.applyPlugins({
    type: runtime.ApplyPluginsType.modify,
    key: 'rootContainer',
    initialValue: /*#__PURE__*/ React__default['default'].createElement(
      RouterComponent,
      {
